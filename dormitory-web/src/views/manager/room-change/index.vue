...
const getPendingList = async () => {
  loading.value = true
  try {
    const res = await request.get('/room/change/list', {
...
const handleApprove = async (row) => {
  try {
    await request.put(`/room/change/approve/${row.id}`)
...
const submitReject = async () => {
  ...
  try {
    await request.put(`/room/change/reject/${currentRow.value.id}`, null, {
