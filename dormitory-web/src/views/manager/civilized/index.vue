...
const getBuildingId = () => userStore.userInfo?.buildingId
...
const getCurrentList = async () => {
  ...
  try {
    ...
    if (getBuildingId()) {
      params.buildingId = getBuildingId()
    }
...
const getHistoryList = async () => {
  ...
  try {
    ...
    const res = await request.get('/civilized/rank', { params })
    const data = res.data
